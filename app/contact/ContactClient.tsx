        ...
        <div className="relative container">
          <div className="max-w-3xl">
            <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              ...
              <span className="text-xs uppercase tracking-[0.2em] text-gold font-semibold block mb-3" style={{ fontFamily: "var(--font-source-sans), system-ui, sans-serif" }}>Contact Us</span>
            </motion.div>
        ...
        <div className="container">
          <div className="grid lg:grid-cols-5 gap-12">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} custom={0}
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-white mb-6" style={{ fontFamily: "var(--font-playfair), Georgia, serif" }}>
              ...
              {submitted ? (
                <div className="bg-white/5 border border-gold/30 p-12 text-center">
                  ...
                  <h3 className="text-2xl font-bold text-white mb-2" style={{ fontFamily: "var(--font-playfair), Georgia, serif" }}>Thank You!</h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="grid md:grid-cols-2 gap-5">
                    <div>
                      <label className="block text-sm text-white/60 mb-2 font-medium" style={{ fontFamily: "var(--font-source-sans), system-ui, sans-serif" }}>Full Name *</label>
                      <input
                        type="text"
                        required
                        value={formData.name}
                    ...
                    <div>
                      <label className="block text-sm text-white/60 mb-2 font-medium" style={{ fontFamily: "var(--font-source-sans), system-ui, sans-serif" }}>Email Address *</label>
                      <input
                        type="email"
                        required
                  ...
                  <div className="grid md:grid-cols-2 gap-5">
                    <div>
                      <label className="block text-sm text-white/60 mb-2 font-medium" style={{ fontFamily: "var(--font-source-sans), system-ui, sans-serif" }}>Phone Number</label>
                      <input
                        type="tel"
                    ...
                    <div>
                      <label className="block text-sm text-white/60 mb-2 font-medium" style={{ fontFamily: "var(--font-source-sans), system-ui, sans-serif" }}>Service Needed</label>
                      <select
                  ...
                  <div>
                    <label className="block text-sm text-white/60 mb-2 font-medium" style={{ fontFamily: "var(--font-source-sans), system-ui, sans-serif" }}>Project Details</label>
                    <textarea
                      rows={5}
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} custom={1}
              ...
              <div className="bg-white/5 border border-white/10 p-6">
                <h3 className="text-lg font-bold text-white mb-4" style={{ fontFamily: "var(--font-playfair), Georgia, serif" }}>Get In Touch</h3>
                <div className="space-y-4">
                  <a href="tel:9704561176" className="flex items-start gap-3 text-white/60 hover:text-gold transition-colors group">
                    ...
                    <div style={{ fontFamily: "var(--font-source-sans), system-ui, sans-serif" }}>
              ...
              <div className="bg-gold/10 border border-gold/30 p-6">
                ...
                <h3 className="text-lg font-bold text-white mb-2" style={{ fontFamily: "var(--font-playfair), Georgia, serif" }}>Prefer to Talk?</h3>
                <p className="text-sm text-white/60 mb-4" style={{ fontFamily: "var(--font-source-sans), system-ui, sans-serif" }}>
                  Our team is standing by to answer your questions and schedule your free inspection.
                </p>
                <a href="tel:9704561176" className="inline-flex items-center gap-2 bg-gold hover:bg-gold-light text-navy-dark px-6 py-3 text-sm font-semibold tracking-wide transition-all w-full justify-center" style={{ fontFamily: "var(--font-source-sans), system-ui, sans-serif" }}>
                  <Phone size={16} />
                  CALL NOW
                </a>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-6">
                <h3 className="text-lg font-bold text-white mb-3" style={{ fontFamily: "var(--font-playfair), Georgia, serif" }}>What to Expect</h3>
                <ul className="space-y-2">
                  {[
                    ...
                    <li key={item} className="flex items-center gap-2 text-sm text-white/50" style={{ fontFamily: "var(--font-source-sans), system-ui, sans-serif" }}>
