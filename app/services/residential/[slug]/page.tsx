    ...
    <div className="bg-[#0a1628]">
      ...
      <section className="relative min-h-[50vh] flex items-center overflow-hidden">
        ...
        <div className="container relative z-10 py-24">
          <Link href="/services/residential" className="inline-flex items-center gap-2 text-[#c9a84c] hover:text-[#d4b65c] text-sm font-medium mb-6 transition-colors">
        ...
        <div className="container">
          <div className="bg-gradient-to-r from-[#c9a84c] to-[#b8953f] rounded-2xl p-12 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact">
                <button
                  onClick={() => trackEstimateRequest('service_detail', 'residential')}
