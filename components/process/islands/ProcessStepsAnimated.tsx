          ...
          >
            ...
            <div className="hidden md:flex flex-col items-center">
              <div className="w-16 h-16 bg-gold/10 border-2 border-gold flex items-center justify-center flex-shrink-0">
                <span className="text-gold font-bold text-lg" style={{ fontFamily: "var(--font-playfair), Georgia, serif" }}>{step.number}</span>
              </div>
              {i < steps.length - 1 && (
            ...
            <div className="flex-1 pb-2">
              <div className="md:hidden flex items-center gap-3 mb-4">
                <div className="w-12 h-12 bg-gold/10 border-2 border-gold flex items-center justify-center flex-shrink-0">
                  <span className="text-gold font-bold" style={{ fontFamily: "var(--font-playfair), Georgia, serif" }}>{step.number}</span>
                </div>
                <Icon size={20} className="text-gold" />
              </div>
              <div className="flex items-center gap-3 mb-3">
                <Icon size={20} className="text-gold hidden md:block" />
                <h3 className="text-2xl font-bold text-white" style={{ fontFamily: "var(--font-playfair), Georgia, serif" }}>{step.title}</h3>
              </div>
              <p className="text-white/60 mb-4 leading-relaxed" style={{ fontFamily: "var(--font-source-sans), system-ui, sans-serif" }}>
                {step.description}
              </p>
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                {step.details.map((detail) => (
                  <li key={detail} className="flex items-center gap-2 text-sm text-white/50" style={{ fontFamily: "var(--font-source-sans), system-ui, sans-serif" }}>
