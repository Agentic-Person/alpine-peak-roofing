...
import { MapPin, ArrowRight, Phone, CheckCircle, ChevronRight } from 'lucide-react';
...
/**
 * Client island for service detail pages.
 * Handles: GA4 tracking on mount, framer-motion animations, FAQ accordion,
 * testimonial carousel, location grid hover states.
 */
export function ServiceDetailClient({
  ...
  const backHref = `/services/${category}`;
  const backLabel = category === 'residential' ? 'Residential Services' : 'Commercial Services';
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              ...
              >
                <h2 className="font-['Playfair_Display'] text-3xl text-white font-bold mb-6">
                  Overview
                </h2>
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {service.features.map((feature, i) => (
                    <div
                      key={i}
                      className="flex items-start gap-3 bg-[#0f2035] rounded-lg p-4 border border-[#1a3050]"
                    >
            ...
            <div className="space-y-6">
              ...
              >
                <h3 className="font-['Playfair_Display'] text-xl text-white font-bold mb-4">
                  Get Started Today
                </h3>
                <p className="text-gray-400 text-sm mb-6">
                  Contact us for a free consultation and estimate. Our experts will assess your needs
                ...
                <div className="space-y-3">
                  ...
                  <a
                    href="tel:9704468995"
                    className="w-full border border-[#c9a84c] text-[#c9a84c] px-6 py-3 rounded-lg font-semibold hover:bg-[#c9a84c]/10 transition-colors inline-flex items-center justify-center gap-2"
                  >
                  ...
                  <div className="mt-6 pt-6 border-t border-[#1a3050]">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {service.materials.map((mat, i) => (
                        <span
                          key={i}
                          className="bg-[#c9a84c]/10 text-[#c9a84c] text-xs px-3 py-1 rounded-full"
                        >
                          {mat}
                        </span>
                      ))}
                  ...
                  <Link href={`/services/${related.category}/${related.slug}`}>
                    <div className="group bg-[#0f2035] rounded-xl overflow-hidden border border-[#1a3050] hover:border-[#c9a84c]/50 transition-all cursor-pointer">
                      ...
                      <div className="p-5">
                        ...
                        <h3 className="text-white font-semibold mt-1 group-hover:text-[#c9a84c] transition-colors">
                          {related.title}
                        </h3>
            ...
            >
              ...
              <p className="text-gray-400 mt-3 max-w-2xl mx-auto">
                {category === 'residential'
                  ? 'Real reviews from Colorado homeowners who chose Alpine Peak Roofing.'
                ...
                >
                  <div className="flex gap-1 mb-4">
                    {Array.from({ length: 5 }).map((_, si) => (
                      <svg
                        key={si}
                        className={`w-5 h-5 ${si < testimonial.rating ? 'text-[#c9a84c]' : 'text-gray-600'}`}
                        fill="currentColor"
                        viewBox="0 0 20 20"
                      >
      ...
      <section className="py-16 bg-[#0a1628]">
        <div className="container">
          ...
          >
            ...
            <p className="text-gray-400 mt-3 max-w-2xl mx-auto">
              Our {service.title.toLowerCase()} services are available in all our mountain service
              areas.
            </p>
          </motion.div>
              ...
              >
                <Link href={`/locations/${loc.slug}`}>
                  <div className="group bg-[#0f2035] border border-[#1a3050] hover:border-[#c9a84c]/50 rounded-lg p-4 text-center transition-all cursor-pointer hover:bg-[#0f2035]/80">
                    ...
                    <span className="text-white text-sm font-medium group-hover:text-[#c9a84c] transition-colors block">
                      {loc.name}
                    </span>
        ...
        <div className="container">
          <div className="bg-gradient-to-r from-[#c9a84c] to-[#b8953f] rounded-2xl p-12 text-center">
            ...
            <p className="text-[#0a1628]/80 max-w-2xl mx-auto mb-8">
              Contact Alpine Peak Roofing today for a free consultation. Our experts will assess
              your needs and provide a detailed, transparent estimate.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact">
                <button
                  onClick={() => trackEstimateRequest('service_detail', category)}
